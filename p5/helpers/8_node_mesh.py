...
if __name__=="__main__":
    with open("meshes/fpin_8_node.dat", "r") as f:
        lines = f.readlines()

    # exract all node ids and coordinates
    coords = {}
    coord_data = lines[3:19]
    line_ind = 0
    ...
    ele_dict = {}
    elem_data = lines[21:25]
    n_lines = len(elem_data)
    line_ind = 0
    while True:
        line1 = elem_data[line_ind]
        line1 = [float(x) for x in line1.split()]
        ele, mat_set, n1, n2, n3, n4, n5, n6, n7, n8, gen_incr = line1
        ...
        if gen_incr != 0:
            ...
            ele2, mat_set2, n1_2, n2_2, n3_2, n4_2, n5_2, n6_2, n7_2, n8_2, gen_incr_2 = line2

            for i in range(int(ele), int(ele2) + 1):
                # ele_dict[i] = [n1, n2, n3, n4, n5, n6, n7, n8]
            ...
            # ele_dict[ele] = [n1, n2, n3, n4, n5, n6, n7, n8]
    ...
    # line_list = [[(x1, x2), (x2, x3), (x3, x4), (x4, x5), (x5, x6), (x6, x7), (x7, x8), (x8, x1)] for x1, x2, x3, x4, x5, x6, x7, x8 in ele_dict.values()]
    ...
    f.savefig('8_node_mesh.pdf', bbox_inches='tight')
