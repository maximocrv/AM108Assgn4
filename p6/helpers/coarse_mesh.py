...
if __name__=="__main__":
    with open("../Coarse_mesh/fpin.dat", "r") as f:
        lines = f.readlines()

    # exract all node ids and coordinates
    coords = {}
    coord_data = lines[3:254]
    line_ind = 0
    ...
    ax.scatter(*np.array(list(coords.values())).T, marker='o', color='r', s=8)
    ...
    f.savefig('coarse_mesh_q6.pdf', bbox_inches='tight')
